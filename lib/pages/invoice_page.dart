...
class _InvoicePageState extends State<InvoicePage> {
  ...
  Future<void> getOrderFull() async {
    await context.read<InvoiceProvider>().getOrderResultFull(
        context.read<OrderSummaryProvider>().orderResult.publicId);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: context.watch<InvoiceProvider>().isLoading
          ? Center(
                            ...
                            child: Column(
                              children: [
                                ...
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    const Icon(FontAwesomeIcons.phoneFlip),
                                    const SizedBox(
                                      width: 4,
                                    ),
                                    Text(
                                        ...
                                        return TableRow(
                                          children: [
                                            ...
                                            Padding(
                                              padding:
                                                  const EdgeInsets.all(8.0),
                                              child: Text(orderProduct.quantity
                                                  .toString()),
                                            ),
                                            Padding(
                                              padding:
